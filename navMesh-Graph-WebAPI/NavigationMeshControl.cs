...
namespace navMesh_Graph_WebAPI
{
    public class NavigationMeshControl
    {
        ...
        private NavigationMeshControl()
        {
            ...
            List<NavigationMeshPolyFootpath> navigationMeshesFootpathsList = LoadDataFromDumpFile<List<NavigationMeshPolyFootpath>>("../../../newNavigationMeshes.msgpack");
            ...
            where TDumpType : new()
        {
            ...
            {
                Console.WriteLine($"Could not find dump file at {filePath}");
                return default;
            }
            ...
            {
                Console.WriteLine($"Failed loading dump: {e}");
            }
